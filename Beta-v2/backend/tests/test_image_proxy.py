...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("avatars.githubusercontent.com.attacker.example", False),
        ("i.ytimg.com.attacker.example", False),
        ("evil.ytimg.com", False),
        ("encrypted-tbn0.gstatic.com.attacker.example", False),
