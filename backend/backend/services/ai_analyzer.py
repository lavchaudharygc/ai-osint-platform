...
""".strip()
    ...
    def _fallback_correlation(self, primary_profile: dict[str, Any], discovered_profiles: list[dict[str, Any]], reason: str) -> dict[str, Any]:
        ...
        return {
            ...
            "parsed": {
                ...
                "next_steps": ["Configure DEEPSEEK_API_KEY or GROQ_API_KEY for full AI analysis", "Manually verify profile photos, bios, and linked URLs"],
            },
    ...
    def _fallback_risk(self, profile_data: dict[str, Any], reason: str) -> dict[str, Any]:
        return {
            ...
            "status": "not_configured",
            "reason": reason,
            "analysis": "Configure DEEPSEEK_API_KEY or GROQ_API_KEY for AI risk assessment.",
